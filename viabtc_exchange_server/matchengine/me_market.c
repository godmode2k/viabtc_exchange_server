...
//
// inc/dec quote-currency only (AAA-BBB => BBB)
///*
...
///*
            ...
            if (real) {
                append_balance_trade_fee(maker, m->money, bid_fee, price, amount, maker->maker_fee);
            }
//*/
// ]
        }
...
///*
            ...
            if (real) {
                append_balance_trade_fee(taker, m->money, bid_fee, price, amount, taker->taker_fee);
            }
//*/
// ]
        }
